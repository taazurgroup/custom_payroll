...
app_description = "Custom Payroll"
...
# get_website_user_home_page = "custom_payroll.utils.get_home_page"
...
doc_events = {
    ...
    "Payroll Entry": {
        "onload": "custom_payroll.custom_payroll_classes.build_my_thing"
    }
}
# Scheduled Tasks
# ---------------
